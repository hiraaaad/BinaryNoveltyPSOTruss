...
function A=find_Agoal_ASD2(L_member,f_int_ext,AAP,A,Ri,Fy,M_elasticity,section_no,sym_A,Avar_ind,max_member_vio,opt)
...
activeAvar_ind= intersect(find(max_member_vio>1),intersect(Avar_ind, find(AAP))); % active independent members
Max_Avar=1e100;
