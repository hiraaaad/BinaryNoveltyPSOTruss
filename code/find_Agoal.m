function [Agoal]=find_Agoal(L_link,Def_ratio,Def_all,Kg_red,Felement,Deflection,keep_DOF,keep_L_mat,AAP,A,Ri,Fy,TA,elastic,Max_A,Min_A,Pzarib,Max_Avar,bias_round,section_no,sym_AAP,D,AAPvar_ind,Avar_ind,nodes,NAP,DOF_const_ind,Max_Kcond,Fexter,meghdar)
...
for r=activeAvar_ind
        ...
        Max_Avar_dec=1.0000001;%(Max_Avar-1)*FSDA(r)+1; 
